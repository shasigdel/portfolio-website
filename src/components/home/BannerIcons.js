...
import { SiGo, SiDjango, SiFlask, SiSpringboot, SiMongodb, SiPostgresql, SiKubernetes, SiGithub, SiTailwindcss, SiNodedotjs, SiCss3, SiPostman, SiHibernate, SiRabbitmq } from 'react-icons/si';

const BannerIcons = () => {
  return (
    <div className="flex flex-col items-center gap-10 mt-10 ">
      <h4 className="text-3xl font-titleFont text-gray-200">Technologies</h4>
